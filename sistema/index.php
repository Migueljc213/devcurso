...
<head>
	...
	<meta name="description" content="Portal de Cursos Profissionalizantes DevCurso, Participe das nossas formações e seja um profissional reconhecido!!">
	<meta name="author" content="Vinícius Almeida">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-4 login-sec">
						<h5 class="text-center mb-4"><a href="../" title="Voltar para o Site"><img class="mr-1" src="img/logo.png" width="200px"></a></h5><h5 class="text-center mb-4">Faça seu Login</h5>
